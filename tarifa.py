...
#The provider will let Pero use up XX megabytes to surf the internet per month. 
...
#If we know how much megabytes Pero has spent in each of the first NN months of using the plan, 
#determine how many megabytes Pero will have available in the N+1N+1 month of using the plan.

#Input
#The first line of input contains the integer X (1≤X≤100). 
#The second line of input contains the integer N (1≤N≤100). 
#Each of the following NN lines contains an integer Pi (0≤Pi≤10000), 
